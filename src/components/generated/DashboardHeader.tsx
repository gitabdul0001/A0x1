...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  const handleNotificationClick = () => {
    onShowNotification('Notifications', <div className="space-y-3">
        <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border-l-4 border-blue-500">
          <p className="font-medium text-blue-900 dark:text-blue-100">New follower on Instagram</p>
          <p className="text-sm text-blue-700 dark:text-blue-300">@johndoe started following your account</p>
        </div>
        <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border-l-4 border-green-500">
          <p className="font-medium text-green-900 dark:text-green-100">Post scheduled successfully</p>
          <p className="text-sm text-green-700 dark:text-green-300">Your LinkedIn post is scheduled for 2:00 PM</p>
        </div>
        <div className="p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border-l-4 border-yellow-500">
          <p className="font-medium text-yellow-900 dark:text-yellow-100">Content approval needed</p>
          <p className="text-sm text-yellow-700 dark:text-yellow-300">Review pending posts in your queue</p>
        </div>
      </div>);
  };
  ...
  return <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
      <div className="flex items-center justify-between">
        {/* Left Section */}
        <div className="flex items-center space-x-4">
          {/* Mobile Menu Button */}
          <button onClick={onToggleMobileMenu} className="lg:hidden p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors" aria-label="Toggle mobile menu">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative">
            ...
            scale: 0.98
              ...
              <div className="w-8 h-8 rounded-full bg-[#FDE9D6] flex items-center justify-center overflow-hidden">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 400 400" className="w-full h-full">
                  <path d="M0 0 C132 0 264 0 400 0 C400 132 400 264 400 400 C268 400 136 400 0 400 C0 268 0 136 0 0 Z " fill="#FDE9D6" transform="translate(0,0)" />
